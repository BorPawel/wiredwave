...
const Navbar = () => {
  ...
  return (
    <nav
      className="w-full lg:w-1/2 flex justify-between items-center  md:p-2 px-8 md:px-20 fixed z-50 duration-600 nav_active  top-0 bg-dark border-grey border-[2px] text-white rounded-b-[100px]"
      ref={navRef}
    >
      <Logo />
      <NavigationButtons />
